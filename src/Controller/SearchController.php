...
class SearchController extends AbstractController
{
    ...
    public function __construct(SearchHandler $searchHandler, SampleRepository $sampleRepository)
    {
        ...
        $this->configuration = new Configuration([
            ...
            new Field('email.thread_index', new StringType(), true, true),
            new Field('email.message_uuid', new StringType(), true, true),
            new Field('email.list_uuid', new StringType(), true, true),
            new Field('email.content_uuid', new StringType(), true, true),
